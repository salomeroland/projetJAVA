...
public class CalendarPhysician extends TreeSet<AppPhys> { 
    ...
    public void modApp(AppPhys a) throws AppException{     // a = rdv qui doit être modifié
        ...
        String mod = sc.next();
        AppPhys ret = null;     // ret = rdv modifié
        ...
        switch (mod) {  // on regarde la valeur de mod, et ensuite on va regarder si un cas correspond
            ...
            case ("practitioner"):
                ...
                ret = new AppPhys(a.getPaName(), docName, a.getDay(), a.getMonth(), a.getYear(), a.getDebutHour(), a.getDebutMin());
                this.addApp(ret);
                break;
            ...
            case ("patient"):
                ...
                ret = new AppPhys(paName, a.getDocName(), a.getDay(), a.getMonth(), a.getYear(), a.getDebutHour(), a.getDebutMin());
                this.addApp(ret);
                break;
            ...
            case ("date"):
                ...
                int day = sc.nextInt();
                ret = new AppPhys(a.getPaName(), a.getDocName(), day, month, year, a.getDebutHour(), a.getDebutMin());
                this.addApp(ret);
                break;
            ...
            case ("time"):
                ...
                int min = sc.nextInt();
                ret = new AppPhys(a.getPaName(), a.getDocName(), a.getDay(), a.getMonth(), a.getYear(), hour, min);
                this.addApp(ret);
                break;
            ...
            case ("duration"):
                ...
                int dur = sc.nextInt();
                ret = new AppPhys(a.getPaName(), a.getDocName(), a.getDay(), a.getMonth(), a.getYear(), a.getDebutHour(), a.getDebutMin(), dur);
                this.addApp(ret);
                break;
        }
